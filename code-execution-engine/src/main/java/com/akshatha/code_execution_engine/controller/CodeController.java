...
import com.akshatha.code_execution_engine.dto.RunRequest;
import com.akshatha.code_execution_engine.dto.SubmissionDTO;
import com.akshatha.code_execution_engine.dto.SubmissionDetailDTO;
import com.akshatha.code_execution_engine.dto.TestCaseResultDTO;
import com.akshatha.code_execution_engine.entity.Problem;
import com.akshatha.code_execution_engine.entity.Submission;
import com.akshatha.code_execution_engine.entity.TestCaseEntity;
import com.akshatha.code_execution_engine.executor.CodeExecutionService;
import com.akshatha.code_execution_engine.executor.ExecutionResult;
import com.akshatha.code_execution_engine.executor.JudgeResult;
import com.akshatha.code_execution_engine.executor.TestCase;
...
public Map<String, Object> submitSave(@RequestBody Map<String, Object> req) {
    ...
    public java.util.List<com.akshatha.code_execution_engine.entity.Submission> 
    ...
    public java.util.List<com.akshatha.code_execution_engine.dto.LeaderboardDTO> leaderboard() {
