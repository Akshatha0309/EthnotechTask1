package com.akshatha.code_execution_engine.executor;
...
import com.akshatha.code_execution_engine.repository.TestCaseRepository;
...
public List<TestCaseResultDTO> getTestCaseResults(Long submissionId) {
    ...
    // 🔹 LEADERBOARD
    public List<com.akshatha.code_execution_engine.dto.LeaderboardDTO> getLeaderboard() {

        List<com.akshatha.code_execution_engine.dto.LeaderboardDTO> list =
                submissionRepo.getLeaderboard();

        int rank = 1;

        for (com.akshatha.code_execution_engine.dto.LeaderboardDTO dto : list) {
            dto.setRank(rank++);
        }
